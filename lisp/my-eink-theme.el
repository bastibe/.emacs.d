...
(let ((fg "#111111")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-delimiter-face ((t (:foreground "#303030" :slant italic))))
   `(font-lock-comment-face ((t (:foreground "#303030" :slant italic))))
   ...
   `(font-lock-string-face ((t (:foreground "#303030"))))
