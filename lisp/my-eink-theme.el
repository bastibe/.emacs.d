...
(let ((fg "#111111")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-delimiter-face ((t (:foreground ,fg :slant italic :weight light :family "InputMonoCompressed"))))
   `(font-lock-comment-face ((t (:foreground ,fg :slant italic :weight light :family "InputMonoCompressed"))))
   `(font-lock-constant-face ((t (:foreground ,fg))))
   `(font-lock-doc-face ((t (:foreground ,fg-medium :weight regular :family "UbuntuMono"))))
   ...
   `(font-lock-string-face ((t (:foreground ,fg-medium :family "InputMonoCompressed"))))
   ...
   `(mode-line-inactive ((t (:background ,bg-light :foreground "#606060" :height 1.0))))
   ...
   `(org-block-background ((t (:background ,bg-lighter))))
   `(org-block-begin-line ((t (:foreground ,fg, :background ,bg-lighter))))
   `(org-block-end-line ((t (:foreground ,fg :background ,bg-lighter))))
   `(org-meta-line ((t (:foreground ,fg :background ,bg-lighter))))
   `(org-date ((t (:foreground ,fg) :underline)))
   `(org-done ((t (:foreground ,fg-light))))
   `(org-hide ((t (:foreground ,bg))))
   ;; use :overline to give headings more top margin
   `(org-document-title ((t (:foreground ,fg :weight semi-bold :height 1.4 :underline ,fg :family "InputSerifCompressed"))))
